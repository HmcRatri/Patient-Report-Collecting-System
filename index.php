...
<body>
			...
			<div class=" head-wl">
				...
				<div class="w3-header-top-right">
					<div class="email-right">
						<p><span class="fa fa-envelope" aria-hidden="true"></span> <a href="mailto:ratri1454@gmail.com" class="info"> ratri1454@gmail.com</a></p>

					</div>
					<div class="w3-header-top-right-text">

						<p><span class="fa fa-phone" aria-hidden="true"></span> +01684541424</p>
					</div>
			...
			<nav class="navbar navbar-default navbar-fixed-top">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="patient.php" target="_blank">Patient</a></li>
						<li><a href="login.php?click=staff">Staff</a></li>
			...
			<div class=" col-md-7 contact-address">
				...
				<div class="contact-left">
					<div class="address-contact-left ">
						<h5>Address:</h5>
						<p><span class="fa fa-home"></span> Mirpur Dhaka </p>
					</div>
					<div class="address-contact-left ">
						<h5>Phones:</h5>
						<p><span class="fa fa-phone"></span> +01684541424</p>
						<p><span class="fa fa-phone"></span> +01974541425</p>
					</div>
					<div class="address-contact-left ">
						<h5>Email:</h5>
						<p><span class="fa fa-envelope"></span> <a href="mailto:ratri1454@gmail.com">ratri1454@gmail.com</a></p>
					</div>
				</div>
			</div>
	...
	<div class="footer">
		...
		<div class="colr-row col-md-6  ">
			<div class="col-md-6 col-sm-6 col-xs-6  bottom-head bottm-grid">
				<h2><a href="index.html">Medical</a></h2>
				<span class="cap">Test Report</span>
				<div class="clearfix"> </div>
			</div>
			...
			<div class="col-md-6 col-sm-6 col-xs-6 one bottm-grid">
				<h3>About us</h3>
				<p> Help For Sick People </p>
				<div class="clearfix"></div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-6 three bottm-grid">
				<h3>Contact</h3>
				<div class="addres up-out">
					<p><span class="fa fa-map-marker icons-left" aria-hidden="true"></span>Mirpur Dhaka</p>

					<p><span class="fa fa-phone icons-left" aria-hidden="true"></span>Call us:+8801684541424</p>
	...
	<footer>
		<p>&copy;2018 Medically. All Rights Reserved | Design by <a href="#" target="_blank">Ratri</a></p>
	</footer>
	<!--menu script-->
